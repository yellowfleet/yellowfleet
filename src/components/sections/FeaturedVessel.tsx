...
export function FeaturedVessel({ vessels }: { vessels: Vessel[] }) {
  ...
  return (
    <section className="relative overflow-x-hidden bg-navy px-6 py-24 text-white">
  ...
  <div className="relative z-10 mx-auto max-w-6xl">
    ...
    <AnimatePresence mode="wait" custom={direction}>
      ...
      >
        ...
        <button
          onClick={goPrev}
          className="absolute left-2 top-1/2 z-10 hidden h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-navy/60 text-white backdrop-blur-sm transition-colors hover:bg-gold hover:text-navy sm:flex"
        ...
        <button
          onClick={goNext}
          className="absolute right-2 top-1/2 z-10 hidden h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-navy/60 text-white backdrop-blur-sm transition-colors hover:bg-gold hover:text-navy sm:flex"
          aria-label="Next vessel"
        >
          →
        </button>

        <div className="grid min-w-0 gap-8 overflow-hidden rounded-none bg-white/5 p-0 lg:grid-cols-2">
          {/* Image gallery */}
          <div className="flex min-w-0 flex-col gap-3">
            <div className="relative flex w-full items-center justify-center overflow-hidden">
              <img
                ...
                className="block h-auto w-full object-contain opacity-90 transition-all duration-500 sm:h-full sm:w-full"
              />
